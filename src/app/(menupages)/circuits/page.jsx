...
import {
  circuitCharacteristicsMap,
  normalizeCircuitName,
  calculateCharacteristics,
  getPowerSensitivityLabel,
  getDownforceLabel,
  getOvertakingLabel,
  getTireWearLabel,
  getFuelLabel,
  getBrakingLabel
} from '../../../services/circuitCharacteristics';
  ...
  return (
    <motion.div
      ...
      className={`relative w-full min-h-32 bg-linear-to-br from-gray-900/95 via-gray-900/90 to-black/95 
        ...
        ${
          hasValidData
            ? "cursor-pointer hover:shadow-xl hover:shadow-red-500/10"
    ...
    >
      ...
      <motion.div
        ...
        className={`absolute left-0 top-0 h-full bg-linear-to-b ${getCircuitColor(
          circuit.circuitId
        )}`}
      />
      ...
      <div className="relative z-10 flex h-full">
        ...
        <div className="flex-1 p-5 flex flex-col justify-between">
          <div>
            ...
            <motion.h3
              ...
              className="text-xl font-bold text-white mb-2 ml-3 line-clamp-1 font-exo2"
            >
              {circuit.circuitName}
            </motion.h3>
            ...
            <div className="flex items-center gap-3 pl-4">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2">
                  <span className="text-md font-orbitron font-bold left-3 text-gray-300 line-clamp-1">
          ...
          <div className="mt-4">
            <span className="text-md font-mono text-white font-racing uppercase tracking-widest">
              {circuit.circuitId}
            </span>
          </div>
        </div>
        ...
        <div className="hidden sm:flex flex-1 p-5 font-orbitron underline-offset-2">
          <div className="grid grid-cols-2 gap-4 h-full w-full">
            {/* Top Row Stats */}
            <motion.div
              whileHover={{ scale: hasValidData ? 1.05 : 1 }}
              className="p-3 bg-linear-to-br from-gray-900/80 to-black/80 backdrop-blur-sm rounded-xl border-2 border-red-500"
            >
            ...
            >
              ...
              <p className="text-lg md:text-xl lg:text-2xl font-bold text-cyan-300 truncate">
...
const DetailPanel = ({ circuit, onClose }) => {
  ...
  const getCircuitImage = (circuitId) => {
    const circuitImages = {
      ...
      adelaide: "/circuits/default-circuit.jpg",
    };
  ...
  return (
    <motion.div
      ...
      exit={{ opacity: 0, x: 20 }}
      className="sticky top-8 h-[calc(100vh)] flex flex-col bg-linear-to-br from-gray-900 via-black to-gray-900 
        backdrop-blur-xl rounded-2xl overflow-hidden border border-gray-800 shadow-2xl"
    >
      {/* F1-style Header with Red Accent */}
      <div className="relative p-6 border-b border-gray-800 shrink-0">
        <div className="absolute top-0 left-0 w-full h-1 bg-linear-to-r from-red-600 via-yellow-500 to-red-600" />

        <div className="flex items-start justify-between">
          <div className="flex-1 mr-4">
            <div className="flex items-center gap-3 mb-2 font-exo2">
              <div className="px-3 py-1 bg-red-600 rounded-full">
                <span className="text-xs font-bold text-white uppercase tracking-widest">
                  {hasValidData ? "F1 CIRCUIT" : "HISTORICAL CIRCUIT"}
                </span>
              </div>
              <span className="text-md font-semibold underline text-gray-200">
                #{circuit.circuitId}
              </span>
            </div>

            <h2 className="text-2xl font-bold bg-linear-to-r from-white via-red-100 to-white bg-clip-text text-transparent mb-2 font-oxanium">
              {circuit.circuitName}
            </h2>
            ...
            <div className="flex items-center gap-3 font-exo2">
              ...
              <span className="text-md text-gray-400">
                Since {circuit.firstParticipationYear || "N/A"}
              </span>
            </div>
          </div>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            onClick={onClose}
            className="p-2 hover:bg-gray-800/50 rounded-xl transition-all duration-300 shrink-0"
          >
            <svg
        ...
        <div className="flex gap-2 mt-6">
          {["info", "fastest", "layout"].map((tab) => (
            <motion.button
              ...
              whileHover={{
                scale:
                  tab !== "fastest" || circuit.fastestLapDriverId ? 1.05 : 1,
              }}
              whileTap={{
                scale:
                  tab !== "fastest" || circuit.fastestLapDriverId ? 0.95 : 1,
              }}
              onClick={() =>
                (tab !== "fastest" || circuit.fastestLapDriverId) &&
                setActiveTab(tab)
              }
              className={`px-3 py-1 rounded-lg text-md font-bold transition-all duration-300 ${
                activeTab === tab
                  ? "bg-linear-to-r from-red-600 to-red-700 border-2 border-white text-white shadow-lg shadow-red-500/20"
                  : tab === "fastest" && !circuit.fastestLapDriverId
          ...
          >
            {activeTab === "info" && (
              <div className="space-y-6">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-yellow-300/70 mt-1">
                          This is a historical Formula 1 circuit. Detailed
                          racing data is not available.
                        </p>
                      </div>
                    </div>
                  </motion.div>
                ...
                >
                  <h4 className="text-lg font-bold text-white mb-4 flex items-center gap-2 font-exo2">
                    <svg
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="text-center p-3 bg-gray-900/30 rounded-lg">
                      <p className="text-sm text-gray-400 mb-1">Corners</p>
                      <p className="text-md font-bold text-white">
                        {circuit.numberOfCorners || "N/A"}
                      </p>
                    </div>
                    <div className="text-center p-3 bg-gray-900/30 rounded-lg">
                      <p className="text-sm text-gray-400 mb-1">First GP</p>
                      <p className="text-md font-bold text-white">
                        {circuit.firstParticipationYear || "N/A"}
                      </p>
                    </div>
                ...
                {circuit.fastestLapDriverId && (
                  ...
                  >
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center gap-3">
                        <div
                          className="w-10 h-10 bg-linear-to-br from-yellow-600 to-yellow-800 
            ...
            {activeTab === "fastest" && circuit.fastestLapDriverId && (
              <div className="space-y-6">
                ...
                >
                  <div className="flex items-center justify-between mb-6 font-oxanium">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div className="text-center">
                      <div className="relative w-20 h-20 mx-auto mb-3">
                        <motion.div
                          ...
                          className="absolute inset-0 rounded-full border-2 border-yellow-500/30 border-t-transparent"
                        />
                        <div className="absolute inset-0 flex items-center justify-center">
                          <div
                            className="w-16 h-16 bg-linear-to-br from-red-600 to-red-800 rounded-full 
                    ...
                    <div className="text-center">
                      <div className="relative w-20 h-20 mx-auto mb-3">
                        <div
                          className={`absolute inset-0 rounded-full ${getTeamColor(
                      ...
                      <p className="text-sm font-bold text-white truncate">
                        {circuit.fastestLapTeamId
                          ? formatDriverName(circuit.fastestLapTeamId)
                          : "N/A"}
                      </p>
                    </div>
                    ...
                    <div className="text-center">
                      <div className="relative w-20 h-20 mx-auto mb-3">
                        <div
                          className="absolute inset-0 bg-linear-to-br from-yellow-200 to-yellow-800 
                          rounded-full flex items-center justify-center"
                        >
            ...
            {activeTab === "layout" && (
              <div className="space-y-6">
                ...
                <motion.div
                  ...
                  className="p-4 bg-linear-to-r from-gray-900/50 to-black/50 rounded-xl border border-gray-800"
                >
                  <div className="flex items-center justify-between mb-4 font-orbitron">
                    <div>
                  ...
                  <div className="relative h-56 bg-linear-to-br from-gray-900 to-black rounded-lg overflow-hidden">
                    {!imageError ? (
                      <motion.div
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                  ...
                  {/* Layout Stats */}
                  <div className="grid grid-cols-4 gap-3 mt-4 font-exo2">
                    ...
                    <div className="text-center p-2 bg-linear-to-br from-gray-900/30 to-black/30 rounded-lg">
                      <p className="text-sm text-gray-400">First GP</p>
                      <p className="text-md font-bold text-white">
                        {circuit.firstParticipationYear || "N/A"}
                      </p>
                    </div>
                    <div className="text-center p-2 bg-linear-to-br from-green-300 to-green-400 rounded-lg">
      ...
      <div className="p-6 border-t border-gray-800 shrink-0">
        ...
        >
          <span className="truncate">WIKIPEDIA PAGE</span>
          <svg
...
const CircuitsComponent = () => {
  ...
  const fetchCircuits = async () => {
    try {
      ...
      const validCircuits = data.circuits.filter(
        (circuit) =>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="space-y-4">
            {[...Array(6)].map((_, i) => (
              <div
                key={i}
                className="flex bg-linear-to-r from-gray-900/50 to-black/50 rounded-2xl p-6 animate-pulse"
              >
                {/* Left side */}
    ...
    return (
      <div className="min-h-screen bg-linear-to-br from-gray-950 via-black to-gray-950 p-4 md:p-8">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div
              className="w-20 h-20 mx-auto mb-6 bg-linear-to-br from-red-900/30 to-black/50 
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-950 via-black to-gray-950 p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-6 font-orbitron">
            <div>
        ...
        <div className="flex flex-col lg:flex-row gap-8 relative">
          ...
          <div
            className={`${
              selectedCircuit && !isMobile ? "lg:w-2/3" : "w-full"
            }`}
          >
            <div className="space-y-4">
              <AnimatePresence>
                {circuits.map((circuit, index) => (
                  <CircuitCard
                    ...
                    index={index}
                    isSelected={
                      selectedCircuit?.circuitId === circuit.circuitId
                    }
          ...
          {/* Detail Panel - Sticky positioned */}
          <AnimatePresence>
        ...
        >
          <div className="flex flex-col items-center gap-2">
            ...
            <p className="text-sm text-gray-600">
              OFFICIAL FORMULA 1 DATA • © {new Date().getFullYear()} FIA FORMULA
